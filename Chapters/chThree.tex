...
{\begin{center} 4x + 38 = 62 \linebreak 4x + 38 - 38 = 62 - 38 \linebreak $4x$ = 24 \linebreak $\frac{4x}{4}$ = $\frac{24}{4}$ \linebreak x = $8$  \end{center}}
{A letters or symbol can be used to represent a number which isn’t already known, such as "x". 4x + 38 = 62 means that 4*(some number) + 38 = 62.}
{\begin{tikzpicture}
    \coordinate (A) at (0,0);
    \coordinate (B) at (0,1);
    \coordinate (C) at (0,2);
